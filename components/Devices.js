  ...
  return (
    ...
    >
      {device.map((device) => (
        ...
        >
          <div
            className="bg-transparent p-6 my-4 rounded-lg transition duration-300 ease-in-out hover:ease-in"
          >
            <h1
            ...
            >
              ...
              >
                ...
                <p>{device.modelo}</p>
                <p>{device.cpu}</p>
                <p>{device.ram} {device.ram ? "GB de RAM" : ""}</p>
                <p>{device.disco_duro} {device.disco_duro ? "GB de Almacenamiento" : ""}</p>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    {device.congelado == 1 ? (
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                    ) : device.congelado == 0 ? (
                  ...
                  >{device.congelado == 1 ? "Congelado" : device.congelado == 0 ? "No congelado" : ""}</p>
                </div>
                <p
