  ...
  return (
    <div className="w-fit h-full">
      ...
      >
        ...
        <Sidebar.ItemGroup border="rounded-xl border-[#D1D5DB] dark:border-none bg-[#F9FAFB] py-4 px-3 dark:bg-gray-800">
          <Link
          ...
          <Sidebar.Collapse icon={HiTable} label="Formularios">
            ...
            <Link
              ...
              href="/new"
            >
              <span className="px-3 flex-1 whitespace-nowrap">Dispositivo</span>
            </Link>
          </Sidebar.Collapse>
          <Link
            className="flex items-center justify-center rounded-lg p-2 text-base font-normal text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
          ...
          >
            ...
            <span className="px-3 flex-1 whitespace-nowrap">Dispositivos</span>
          </Link>
